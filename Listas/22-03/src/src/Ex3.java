...
public class Ex3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Preencha o vetor a seguir com 8 números inteiros.\n");
        ...
        double total = soma_vetor(vetor, 8);
        int indexMenor = localiza_menor(vetor, 8);
        int indexMaior = localiza_maior(vetor, 8);
        
        System.out.printf("\n\nRelatório:\n");
        System.out.printf("Maior elemento: %d.\n", vetor[indexMaior]);
        System.out.printf("Posição do menor elemento: %d.\n", indexMenor);
